...
# --- State helpers (compatible with multiple LlamaIndex versions) ---
...
def get_pull_request_details(pr_number: int) -> dict[str, Any]:
    """Fetch details of a pull request given its number. Returns author, title, body, diff_url, state, and commit SHAs."""
...
def get_pr_commit_details(head_sha: str) -> list[dict[str, Any]]:
    """Fetch details of a commit given its SHA. Returns a list of changed files with filename, status, additions, deletions, changes, and patch."""
...
context_agent = FunctionAgent(
    ...
    system_prompt=(
        ...
        "3. Then call add_context_to_state with a summary of what you gathered. \n"
        "4. Then hand off to CommentorAgent. \n"
...
commentor_agent = FunctionAgent(
    ...
    system_prompt=(
        ...
        "2. Then you MUST hand off to ReviewAndPostingAgent. \n"
        "DO NOT just write the review as a text response. You MUST use the tools."
    ),
